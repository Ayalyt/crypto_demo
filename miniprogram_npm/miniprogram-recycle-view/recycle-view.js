    ...
    Component({
      ...
      attached: function() {
        this.data.placeholderImage && this.setData({
          placeholderImageStr: r(this.data.placeholderImage, !0)
        }), this.setItemSize({
          array: [],
          map: {},
          totalHeight: 0
      ...
      methods: {
          ...
          if (this._isValid())
            if (t.detail.ignoreScroll || this.triggerEvent("scroll", t.detail), this.currentScrollTop = t.detail.scrollTop, this._pos.height && this.sizeArray.length)
              if (this._isScrollingWithAnimation) this._isScrollingWithAnimation = !1;
                ...
                if (!e && Math.abs(n - i.top) < 1.5 * i.height) this._log("【not exceed height");
                else {
                  this._lastScrollTop = n;
                  var s = this.data.screen;
                  this._log("SHOW_SCREENS", s, n), this._calcViewportIndexes(r, n, (function(s, h, a, c, d) {
                    o._log("scrollDistance", l, "indexes", s, h), e || i.beginIndex !== s || i.endIndex !== h || i.minTop !== a || i.afterHeight !== c ? (o._log("【check】before setData, old pos is", i.minTop, i.maxTop, a, d), o._throttle = !1, i.left = r, i.top = n, i.beginIndex = s, i.endIndex = h, i.minTop = a, i.maxTop = d, i.afterHeight = c, i.ignoreBeginIndex = i.ignoreEndIndex = -1, o.page._recycleViewportChange({
                      detail: {
                        data: o._pos,
                        id: o.id
                      }
        ...
        _getBeforeSlotHeight: function(t) {
          void 0 !== this.data.beforeSlotHeight ? t && t(this.data.beforeSlotHeight) : this.reRender(t)
        },
        ...
        _getIndexes: function(t, e) {
          ...
          for (var i = Math.floor(t / 200), o = Math.ceil(e / 200), r = Math.floor(this.data.width / 200), n = void 0, l = void 0, s = this.sizeMap, h = i; h <= o; h++)
            for (var a = 0; a < r; a++) {
              var c = h + "." + a;
              if (s[c])
        ...
        __calcViewportIndexes: function(t, e) {
          ...
          var o = this.data.beforeSlotHeight || 0,
            ...
            n = e - i.height * r - o,
            l = e + i.height * r - o;
          l > this.totalHeight && (n -= l - this.totalHeight, l = this.totalHeight), n < o && (l += Math.min(o - n, this.totalHeight), n = 0);
          var s = this._getIndexes(n, l),
            h = s.beginIndex,
            a = s.endIndex;
          if (a >= this.sizeArray.length && (a = this.sizeArray.length - 1), !this._isIndexValid(h, a)) return {
            beginIndex: -1,
            endIndex: -1,
            minTop: 0,
            afterHeight: 0,
          ...
          var c = this.sizeArray[a].beforeHeight + this.sizeArray[a].height;
          return {
            beginIndex: h,
            endIndex: a,
            minTop: this.sizeArray[h].beforeHeight,
            afterHeight: this.totalHeight - c,
            maxTop: l
          }
        },
        ...
        _initPosition: function(t) {
          this._pos = {
            left: this.data.scrollLeft || 0,
            top: this.data.scrollTop || 0,
            width: this.data.width,
            height: Math.max(500, this.data.height),
            direction: 0
          }, this.reRender(t)
        },
        _widthChanged: function(t) {
          return this._isReady ? (this._pos.width = t, this.forceUpdate(), t) : t
        },
        _heightChanged: function(t) {
          return this._isReady ? (this._pos.height = Math.max(500, t), this.forceUpdate(), t) : t
        },
        reRender: function(t) {
          var e = this,
            i = void 0,
          ...
          function n() {
            r._lastBeforeSlotHeight === i && r._lastAfterSlotHeight === o || r.setData({
              hasBeforeSlotHeight: !0,
              hasAfterSlotHeight: !0,
              beforeSlotHeight: i,
              afterSlotHeight: o
            }), r._lastBeforeSlotHeight = i, r._lastAfterSlotHeight = o, t && t()
          }
          var l = !1,
            s = !1;
          this.setData({
            ...
            e.createSelectorQuery().select(".slot-before").boundingClientRect((function(t) {
              i = t.height, l = !0, s && n && n()
            })).exec(), e.createSelectorQuery().select(".slot-after").boundingClientRect((function(t) {
              o = t.height, s = !0, l && n && n()
            })).exec()
          }))
        },
