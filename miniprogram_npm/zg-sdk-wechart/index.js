...
var t, e, r = require("../../@babel/runtime/helpers/regeneratorRuntime"),
...
module.exports = (t = {}, e = function(e, r) {
  ...
  if (!t[e].status) {
    ...
    i && i.configurable && Object.defineProperty(u, "exports", {
      set: function(t) {
        "object" === n(t) && t !== u._exports && (u._exports.__proto__ = t.__proto__, Object.keys(t).forEach((function(e) {
          u._exports[e] = t[e]
        }))), u._tempexports = t
      },
      get: function() {
    ...
    }), t[e].status = 1, t[e].func(t[e].req, u, u.exports)
  }
  ...
  ! function(t) {
    ...
    _.prototype = k.constructor = y, y.constructor = _, _.displayName = c(y, s, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
      ...
      dispatchException: function(t) {
        ...
        function n(n, u) {
          return a.type = "throw", a.arg = t, r.next = n, u && (r.method = "next", r.arg = e), !!u
        }
  ...
  function(t, r) {
    "object" == n(u) && void 0 !== e ? e.exports = r() : "function" == typeof define && define.amd ? define(r) : (t = "undefined" != typeof globalThis ? globalThis : t || self).zhuge = r()
  }(this, (function() {
    function t(e) {
    ...
    function d(t, e, r, u) {
      var i, o = arguments.length,
        a = o < 3 ? e : null === u ? u = Object.getOwnPropertyDescriptor(e, r) : u;
      if ("object" == ("undefined" == typeof Reflect ? "undefined" : n(Reflect)) && "function" == typeof Reflect.decorate) a = Reflect.decorate(t, e, r, u);
      else
    ...
    var g, _, y, w = {
        ...
        clone: function(e) {
          ...
          return function e(u) {
            ...
            if ("object" !== t(u) || null === u) return u;
            var a = n(u),
              s = null;
            return i.get(u) ? i.get(u) : (i.set(u, s), "Set" !== a && "Map" !== a && "Array" !== a && "Object" !== a ? r(u) : "Set" === a ? (s = new Set, u.forEach((function(t) {
              s.add(e(t, i))
            })), s) : "Map" === a ? (s = new Map, u.forEach((function(t, r) {
              s.set(r, e(t, i))
            })), s) : ("Array" === a && (s = new Array, o(u, (function(t, r) {
              s[r] = e(t, i)
            }))), "Object" === a && (s = new Object, o(Object.keys(u), (function(t) {
              s[t] = e(u[t], i)
            }))), s))
          }(e)
        },
      ...
      x = function() {
        function t(r, n, u) {
          e(this, t), this.storageFunction = r, this.allData = u || {}, this.allData.did || this.set("did", n.config.did || w.UUID()), this.allData.cuid || this.set("cuid", void 0), w.isEmpty(n.config.utm) || this.set("utm", n.config.utm)
        }
        return i(t, [{
          key: "get",
          value: function(t) {
          ...
          key: "set",
          value: function(t, e) {
            return v(this, void 0, void 0, r().mark((function n() {
              return r().wrap((function(r) {
                for (;;) switch (r.prev = r.next) {
                  case 0:
                    return this.allData[t] = e, r.next = 3, this.storageFunction.set("zg", this.allData);
                  case 3:
                  case "end":
                    return r.stop()
                }
    ...
    var S = function() {
      function t(r, n, u) {
        e(this, t), this.buffer = [], this.currentPage = {
          queryObj: {},
          query: "",
          route: "",
          time: 0,
          ...
          name: "",
          props: {}
        }, this.count = 0, this.countTimer = null, this.pageReady = !1, this.loadReady = !1, _ = r, g = n, y = u, this.referrerDomain = "miniprogram", this.appKey = "", this.config = {
          serverUrl: {
      ...
      return i(t, [{
        ...
        value: function(t, e) {
          return v(this, void 0, void 0, r().mark((function n() {
            ...
            return r().wrap((function(r) {
              for (;;) switch (r.prev = r.next) {
                case 0:
                  return this.appKey = t, this.config = w.merge(this.config, e || {}), r.prev = 2, r.next = 5, g.get();
                case 5:
                  if ((u = r.sent) && u.did) {
                    r.next = 10;
                    break
                  }
                  return r.next = 9, g.getDid();
                case 9:
                  u.did = r.sent;
                case 10:
                  this.storage = new x(g, this, u), this.request = new b(_, this), this.loadReady = !0, this.updateSession("load"), this.freeBuffer(), r.next = 20;
                  break;
                case 17:
                  r.prev = 17, r.t0 = r.catch(2), console.error("sdk初始化失败，缓存读取失败", r.t0);
                case 20:
                case "end":
                  return r.stop()
              }
        ...
        value: function() {
          if (this.loadReady && this.pageReady)
            for (; this.buffer.length;) {
              ...
              e && (t.prototype[e.fnName] || this[e.fnName]).apply(this, e.args)
            }
        }
      }, {
        key: "send",
        ...
        key: "trackBaseData",
        value: function(t) {
          return v(this, void 0, void 0, r().mark((function e() {
            var n, u;
            return r().wrap((function(e) {
              for (;;) switch (e.prev = e.next) {
                case 0:
                  return n = new Date, e.t0 = t, e.t1 = n.getTime(), e.t2 = this.storage.allData.sid, e.t3 = this.storage.allData.cuid, e.t4 = this.cn, e.t5 = w.getTimezone(n), e.t6 = this.currentPage.url, e.t7 = this.prevPage.url, e.t8 = y.os(), e.t9 = y.ov(), e.t10 = y.version(), e.next = 14, y.mnet();
                case 14:
                  return e.t11 = e.sent, e.next = 17, y.net();
                case 17:
                  return e.t12 = e.sent, e.t13 = this.config.vn, e.t14 = this.referrerDomain, e.t15 = this.config.appId, e.t16 = {
                    $eid: e.t0,
                    $ct: e.t1,
                    $sid: e.t2,
                    $cuid: e.t3,
                    ...
                    $net: e.t12,
                    $vn: e.t13,
                    $referrer_domain: e.t14,
                    $wxeid: e.t15
                  }, (u = {
                    dt: "evt",
                    pr: e.t16
                  }).pr = w.merge(u.pr, w.encode(this.config.superProperty)), e.abrupt("return", u);
                case 25:
                case "end":
                  return e.stop()
              }
        ...
        key: "sessionStart",
        value: function() {
          return v(this, void 0, void 0, r().mark((function t() {
            var e, n, u, i, o;
            return r().wrap((function(t) {
              for (;;) switch (t.prev = t.next) {
                case 0:
                  return e = new Date, n = this.storage.allData, u = n.sid, i = n.cuid, t.t0 = u, t.t1 = u, t.t2 = i, t.t3 = this.cn, t.t4 = w.getTimezone(e), t.t5 = this.currentPage.url, t.t6 = this.prevPage.url, t.t7 = y.os(), t.t8 = y.ov(), t.t9 = y.version(), t.next = 14, y.mnet();
                case 14:
          ...
          return v(this, void 0, void 0, r().mark((function e() {
            ...
            return r().wrap((function(e) {
              for (;;) switch (e.prev = e.next) {
                ...
                case 2:
                  return this.updateSession("pv"), e.next = 5, this.trackBaseData("pv");
                case 5:
                  return (n = e.sent).dt = "abp", u = {
                    $page_title: this.currentPage.title
                  }, n.pr = w.merge(n.pr, u, t || {}), e.next = 11, this.send(n);
                case 11:
                case "end":
                  return e.stop()
              }
            ...
            return r().wrap((function(t) {
              for (;;) switch (t.prev = t.next) {
                case 0:
                  ...
                  return t.abrupt("return");
                case 2:
                  return this.updateSession("duration"), w.isFunction(this.config.beforeDuration) && this.config.beforeDuration(), e = this.currentPage.time - this.prevPage.time, t.next = 7, this.trackBaseData("dr");
                case 7:
                  return (n = t.sent).dt = "abp", n.pr = w.merge(n.pr, {
                    $dr: e,
        ...
        value: function(t, e) {
          return v(this, void 0, void 0, r().mark((function n() {
            ...
            return r().wrap((function(r) {
              for (;;) switch (r.prev = r.next) {
                case 0:
                  return this.updateSession("track"), r.next = 3, this.trackBaseData(t);
                case 3:
                  return (u = r.sent).pr = w.merge(u.pr, w.encode(e)), r.next = 7, this.send(u);
                case 7:
                case "end":
                  return r.stop()
              }
        ...
        value: function(t, e) {
          return v(this, void 0, void 0, r().mark((function n() {
            ...
            return r().wrap((function(r) {
              for (;;) switch (r.prev = r.next) {
                case 0:
                  return this.storage.set("cuid", t), this.updateSession("identify"), u = new Date, (i = {
                    dt: "usr",
                    pr: {
                      $ct: u.getTime(),
                      $tz: w.getTimezone(u),
                  ...
                  }).pr = w.merge(i.pr, w.encode(e)), r.next = 7, this.trackBaseData("usr");
                case 7:
                  return r.next = 9, this.send(i);
                case 9:
                case "end":
                  return r.stop()
              }
            ...
            return r().wrap((function(r) {
              for (;;) switch (r.prev = r.next) {
                case 0:
                  ...
                  }, r.next = 4, this.trackBaseData("usr");
                case 4:
                  return r.next = 6, this.send(i);
                case 6:
                case "end":
                  return r.stop()
              }
        ...
        value: function(t, e, n) {
          return v(this, void 0, void 0, r().mark((function u() {
            var i, o, a, s;
            return r().wrap((function(r) {
              for (;;) switch (r.prev = r.next) {
                case 0:
                  return this.updateSession("track count"), i = Date.now() - this.countStartTime, n && (i -= this.config.countDuration), o = this.count, this.count = n ? 0 : 1, r.next = 7, this.trackBaseData(t);
                case 7:
                  return a = r.sent, s = {}, w.isObject(e) && (s = w.clone(e)), a.pr = w.merge(a.pr, w.encode(s), w.encode({
                    count: o,
                    countTime: i
                  })), r.next = 13, this.send(a);
                case 13:
                case "end":
                  return r.stop()
              }
            ...
            return r().wrap((function(e) {
              for (;;) switch (e.prev = e.next) {
                case 0:
                  ...
                  }, this.updateSession("track revenue"), e.next = 4, this.trackBaseData("revenue");
                case 4:
                  (n = e.sent).dt = "abp", (u = w.merge({
                    price: 0,
                    total: 0,
                    productID: null,
                    productQuantity: 0,
                    revenueType: null
                  }, t)).total = i(u.price, u.productQuantity), o = ["productID", "revenueType"], a = ["price", "total", "productQuantity"], s = {}, e.t0 = r().keys(u);
                case 12:
                  if ((e.t1 = e.t0()).done) {
                    e.next = 21;
                    break
                  }
                  if (c = e.t1.value, -1 !== o.indexOf(c) || -1 !== a.indexOf(c)) {
                    e.next = 16;
                    break
                  }
                  return e.abrupt("continue", 12);
                case 16:
                  m = u[c], a.indexOf(c) > -1 && ((m = Number(m)) || (m = 0)), s["$" + c] = m, e.next = 12;
                  break;
                case 21:
                  return n.pr = w.merge(n.pr, s), e.next = 24, this.send(n);
                case 24:
                case "end":
                  return e.stop()
              }
        ...
        value: function(t) {
          return v(this, void 0, void 0, r().mark((function e() {
            ...
            return r().wrap((function(e) {
              for (;;) switch (e.prev = e.next) {
                case 0:
                  null !== (n = w.filterUtm(t)) && (this.storage.set("utm", n), this.updateSession("setUtm"));
                case 2:
                case "end":
                  return e.stop()
              }
    ...
    d([k], S.prototype, "environmentInfo", null), d([k], S.prototype, "sessionEnd", null), d([k], S.prototype, "sessionStart", null), d([k], S.prototype, "updateSession", null), d([k], S.prototype, "click", null), d([k], S.prototype, "pv", null), d([k], S.prototype, "duration", null), d([k], S.prototype, "track", null), d([k], S.prototype, "identify", null), d([k], S.prototype, "setPushClient", null), d([k], S.prototype, "trackCount", null), d([k], S.prototype, "trackRevenue", null), d([k], S.prototype, "setUtm", null);
    ...
    var W = function(t) {
      ...
      function u(t) {
        var r;
        return e(this, u), (r = n.call(this, D, T, q)).openData = {
          path: "",
          props: {}
        }, r.shared = !1, r.semiAutoTrackEventCatch = {}, r.isShareOperation = !1, I = t, r.initLifeCycleHook(), r
      }
      return i(u, [{
        ...
        value: function(t) {
          ...
          return v(this, void 0, void 0, r().mark((function t() {
            ...
            return r().wrap((function(t) {
              for (;;) switch (t.prev = t.next) {
                case 0:
                  return e = {}, u = w.getCurrentPage(), this.config.forwardShare && this.openOptions && (e.$share_open_type = 1008 === this.openOptions.scene ? "群聊" : "聊天", this.openOptions.query && this.openOptions.query.zg_share_level && (e.$share_level = Number(this.openOptions.query.zg_share_level)), u.data && u.data.zg_share_data && (e = w.merge(e, w.encode(u.data.zg_share_data)))), t.next = 5, n.pv.call(this, e);
                case 5:
                case "end":
                  return t.stop()
              }
        ...
        value: function(t, e) {
          ...
          return v(this, void 0, void 0, r().mark((function n() {
            ...
            return r().wrap((function(r) {
              for (;;) switch (r.prev = r.next) {
                case 0:
                  return u = t.target, o = u.dataset.title, a = u.dataset.index, s = "alipay-miniprogram" === this.referrerDomain ? ["", "", t.detail.pageX, t.detail.pageY] : ["", "", t.detail.x, t.detail.y], r.next = 7, i.click.call(this, t, w.merge({
                    $element_content: o || "",
                    $element_selector: a || "",
                    $element_style: s
                  }, e || {}));
            ...
            return r().wrap((function(e) {
              for (;;) switch (e.prev = e.next) {
                ...
                case 2:
                  ...
                  return this.shared = !1, e.abrupt("return");
                case 5:
                  if (n = t.query || {}, u = this.currentPage.route, !(I.isCartShare(t.scene) && n.zg_uid && n.zg_share_id)) {
                    e.next = 24;
                    break
                  }
                  for (a in i = {
                      ...
                      $path: u,
                      $share_open_type: 1008 === t.scene ? "群聊" : "聊天",
                  ...
                  return this.openData = {
                    path: u,
                    props: o
                  }, i = w.merge(i, w.encode(o)), e.next = 19, this.trackBaseData("wxsopen");
                case 19:
                  return (h = e.sent).dt = "abp", h.pr = w.merge(h.pr, i), e.next = 24, this.send(h);
                case 24:
                case "end":
                  return e.stop()
              }
    ...
    d([k], W.prototype, "sceneToUtm", null), d([k], W.prototype, "trackOpenShare", null);
    var G = {
        1e3: {
          utm_source: "其他",
          utm_medium: "其他"
        ...
        return i(n, [{
          ...
          value: function(t, e) {
            ...
            if (wx.getAccountInfoSync) {
              ...
              u && u.miniProgram && u.miniProgram.appId && (r.appId = u.miniProgram.appId)
            }
            return l(s(n.prototype), "load", this).call(this, t, r)
          }
        }]), n
      }(W));
