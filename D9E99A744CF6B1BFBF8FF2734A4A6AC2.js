! function(e) {
  ...
  function a(e) {
    return new Promise((function(t, n) {
      return e.data = e.data || {}, x.blacklist && (-1 < x.blacklist.indexOf("all") && e.data.et || -1 < x.blacklist.indexOf("behavior") && "behavior" === e.data.et) ? t() : (e.data.v = O, e.data.rqc = ++M, function(e) {
  ...
  function u(e) {
    ...
    a(n), (N.circleToken || N.circleByThreeFingers) && ("page" === e.et && "show" === e.en || "behavior" === e.et && "tap" === e.en) && (n.url = "https://hmma.baidu.com/mini.gif?circle=1", n.data.token = N.circleToken, a(n).catch((function(e) {
  ...
  function l() {
    return b || (A.sid = t(), A.rqc = 0, b = Promise.all([Promise.resolve().then((function() {
      ...
      A.uuid = e[0], q.system = r(e[1]), q.network = r(e[2]), 0 < Object.keys(e[3]).length && (q.user = r(e[3])), 0 < Object.keys(e[4]).length && (q.location = r(e[4])), 0 < Object.keys(e[5]).length && (q.userProperty = JSON.stringify(e[5])), "devtools" === q.system.platform && x.latestVersion && function(e, t) {
  ...
  function h() {
    return k || (k = new Promise((function(e) {
      ...
      if (!x.disableCircling && 36 === e.length) {
        ...
        return t ? (N.circleToken = "".concat(t[1], "-").concat(t[2], "-").concat(t[3], "-").concat(t[4], "-").concat(t[5]), new Promise((function(e) {
          j.setClipboardData({
            data: "",
            complete: function() {
              e()
  ...
  function y(e) {
    return w.page.forEach((function(t) {
      p(t.replace("on", "onPage"), e.methods, D[t])
    })), L(e)
  }
  ...
  function v() {
    ...
    try {
      e = require("D43070744CF6B1BFB2561873F04A6AC2.js")
    } catch (e) {
      return void console.error("请把mtj-wx-sdk.config.js文件拷贝到utils目录中")
    }
    e && e.appKey ? (A.key = e.appKey, x.getLocation = e.getLocation || !1, x.disableCircling = e.disableCircling || !1, x.trackStatus = !(!1 === s(T)), function() {
      var e = s(E);
      if (e) {
        Object.keys(e).forEach((function(t) {
          x[t] = e[t]
    ...
    }(), e.hasPlugin ? (m.prototype.constructor = K, module.exports = {
      App: d,
      Page: g,
      Behavior: m,
      Component: y
    }) : (App = d, Page = g)) : console.error("请设置mtj-wx-sdk.config.js文件中的appKey字段")
  }
  var j, b, k, O = "1.9.19",
    S = "https://hmma.baidu.com/mini.gif",
    w = {
    ...
    U = {
      ...
      onShow: function(e) {
        var t = 0 < arguments.length && void 0 !== e ? e : {},
          n = (q.aso.query || []).filter((function(e) {
            return 0 === e.key.indexOf("mtj_")
          }));
        return q.aso.scene = "" + (t.scene || ""), t.referrerInfo && t.referrerInfo.appId ? q.aso.referrerInfo = t.referrerInfo : delete q.aso.referrerInfo, q.aso.path = t.path || "", q.aso.query = Object.keys(t.query || {}).map((function(e) {
          return {
            key: e,
            value: t.query[e]
          }
        })), 0 < n.length && !/(^|,)mtj_/.test(Object.keys(t.query || {}).join(",")) && (q.aso.query = q.aso.query.concat(n)), l().then((function() {
          return function(e) {
    ...
    D = {
      ...
      onShareAppMessage: function(e, t) {
        ...
        n.title && (r.title = "" + n.title), e.target && (r.target = JSON.stringify(e.target)), u(Object.assign({
          et: "share",
          en: "action",
          ep: r
        }, q));
          ...
          if ("tap" !== e.type) {
            if ("touchmove" === e.type && e.touches instanceof Array) {
              ...
              if (3 === e.touches.length) {
                if (R += 1, clearTimeout(J), 3 === R) return N.circleByThreeFingers = !0, N.circleToken = void 0, void u(Object.assign({
                  et: "page",
                  en: "show"
                }, q));
    ...
    V = {
      ...
      setUserInfo: function(e) {
        ...
        return l().then((function() {
          var e = s(P),
            t = n(e, "Object") ? e : {};
          o(r) && (t.tel = q.user.tel = r.substr(r.length - 11)), i(a) && (t.openId = q.user.openId = a), (t.tel || t.openId) && f(P, t), n(r, "Undefined") || o(r) || console.error("手机号 ".concat(r, " 不合法")), n(a, "Undefined") || i(a) || console.error("openid ".concat(a, " 不合法"))
        })).catch((function(e) {
          c("setUserInfo", e)
        }))
      },
      ...
      setUserProperty: function(e) {
        return Promise.resolve().then((function() {
          ...
          Object.keys(e || {}).forEach((function(t) {
            var i = e[t];
            "" !== t && "_" !== t.charAt(0) && "_" !== t.charAt(t.length - 1) && (n(i, "Null") ? r[t] && (delete r[t], o--) : !(n(i, "String") || n(i, "Number") && Number.isFinite(i)) || 256 < t.length || 256 < ("" + i).length || !r[t] && 100 <= o || (r[t] || o++, r[t] = [i, "1"]))
